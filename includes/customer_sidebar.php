    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden sticky top-24">
        ...
        <ul class="py-2">
            ...
            $menu = [
                ...
                ['file' => 'wallet.php', 'label' => 'My Wallet', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a3 3 0 000 6h12m0-2h2a2 2 0 012 2v6a2 2 0 01-2 2H5a3 3 0 01-3-3V8m15 5h.01"></path>'],
