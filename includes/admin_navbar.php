            ...
            <div class="hidden lg:flex items-center gap-1 text-sm">
                ...
                <div class="relative" id="moreDropdown">
                    ...
                    <div class="absolute top-full left-0 mt-1 bg-white rounded-xl shadow-xl py-2 w-48 hidden z-50" id="moreMenu">
                        ...
                        <div class="border-t border-gray-100 my-1"></div>
                        <a href="insights.php" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-red-600 transition-colors <?= $admin_current === 'insights.php' ? 'bg-red-50 text-red-600 font-semibold' : '' ?>">
                            🤖 AI Insights
                        </a>
                    </div>
                </div>
